...
*PIN is set to ```4``` characters. If you are programming _Enterprise Edition_ Security Keys _or_ if you wish to enforce longer PINs, you will need to set it to ```6``` or more.
